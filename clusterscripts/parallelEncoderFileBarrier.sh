...
# How to run
# write SCRIPT='/home/michele.yin/HuffmanCODEC/clusterscripts/parallelEncoderFileBarrier.sh' Position of the script
...
# write ENCODEPARSER=/home/michele.yin/HuffmanCODEC/src/results_averager_encode.py Position of the Python parser
