...
# for PROCESSES in 1 2 4; do for THREADS in 1 2 4 6 8 10 12 16 20 24; do export PROCESSES; export THREADS; export INPUT;export OUTPUTFOLDER; qsub -N Decoder${THREADS} -l select=1:ncpus=${THREADS}:mem=4gb '/home/michele.yin/HuffmanCODEC/clusterscripts/parallelEncoderNOMPI.sh'; done; done